                      ...
                      Padding(
                          ...
                          child: new FlatButton(
                            ...
                            onPressed: () {
                              ...
                              MaterialPageRoute(builder: (context) => LatestUpload()),
                              );
                              /*...*/
                            },
                            child: Text(
                      ...
                      Padding(
                        ...
                        child: FlatButton(
                          ...
                          padding: EdgeInsets.all(8.0),
                            onPressed: () {
                              Navigator.push(context,
                              MaterialPageRoute(builder: (context) => CategoryOne()),
                              );
                              /*...*/
                            },
                          child: Text(
                      ...
                      Padding(
                        ...
                        child: FlatButton(
                          ...
                          splashColor: Colors.blueAccent,
                            onPressed: () {
                              Navigator.push(context,
                              MaterialPageRoute(builder: (context) => CategoryThree()),
                              );
                              /*...*/
                            },
                          child: Text(
                      ...
                      Padding(
                        ...
                        child: FlatButton(
                          ...
                          splashColor: Colors.blueAccent,
                            onPressed: () {
                              Navigator.push(context,
                              MaterialPageRoute(builder: (context) => CategoryFour()),
                              );
                              /*...*/
                            },
                          child: Text(
